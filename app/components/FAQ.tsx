    ...
    <div className="border-b border-fluid-white-10">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <p className="pb-6 text-fluid-white-70">{answer}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Currently, we support major EVM chains including Ethereum, Polygon, and Optimism. More chains will be added based on community demand.',
    },
    {
      question: 'Can i reestream my earnings?',
      answer:
        'Yes, you can automatically reinvest your earnings by setting up a new stream with your returns, compounding your investment over time.',
    },
    {
      question: 'Can i withdraw my earnings in any moment?',
      answer:
        "Yes, you have the flexibility to withdraw your earnings at any time, subject to the smart contract's predefined rules for secure withdrawals.",
    },
  ];
  ...
  return (
    ...
    >
      <h2 className="mb-12 text-center text-[40px] font-medium">Frequently Asked Questions</h2>
