...
export const FLUID_FUNDS_SUBGRAPH_URL = 'https://api.studio.thegraph.com/query/104988/fluidfunds/version/latest' as const;
...
export const SUPERFLUID_FLOW_ABI = [
  ...
  },
  {
    "anonymous": false,
    "inputs": [
      { "indexed": false, "internalType": "contract ISuperToken", "name": "_acceptedToken", "type": "address" },
